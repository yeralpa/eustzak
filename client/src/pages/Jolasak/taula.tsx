...
const Home = () => {
  const { data, isLoading, error, refetch, isFetching } = useFetchRandom();
  ...
  if (error) return <div className="p-8 text-center text-red-600 font-serif italic">Errorea: ezin da zerbitzarira konektatu.</div>;
